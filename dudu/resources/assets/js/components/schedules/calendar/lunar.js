...
export default {
	...
	betweenSolarDays : function(year, month, day, l_month, l_day) {
		// console.log('in betweenSolarDays');
		// safari 中 YYYY-MM-DD 格式会得到 NaN
	...
	lunarByBetween : function(year, between) {
		...
		lunarArray.push(m, this.chineseNumber(e));
		return lunarArray;
	},
	//中文月份
